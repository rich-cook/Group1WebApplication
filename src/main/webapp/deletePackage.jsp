...
<head>
    ...
    <script>
        ...
        async function fetchPackage(id) {
            ...
            //jquery code getting the values of each id in the form
                ...
                <div>
                    <form class="p-3 p-xl-4">
                        <div class="mb-3">
                            ...
                            <select id="packageselect" onchange="fetchPackage(this.value)"></select>
